/*
WAP to demonstrate passing an array to a function, 
modifying the second value inside the function, 
and printing the array in both the main function and the 
called function to show that arrays are passed by reference.
*/
